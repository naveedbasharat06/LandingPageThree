  ...
  return (
    <div className=" NutrioScaleWinningChange_bg NutrioScaleWinningChange_bg_Mobile">
      <div className="relative px-[5%] py-[100px] md:py-[150px] lg:py-[175px] pl-30 md:pl-32 lg:pl-40 md:pr-6 lg:pr-10 flex flex-col w-[100%] md:w-[620px] lg:w-[815px] text-center  md:items-start">
        <h2 className="font-[inter] font-light md:font-normal text-[48px] md:leading-[52px] text-center md:text-start  leading-[100%] px-10 md:px-0 mb-2 text-white tracking-[0%]">
          Join the waiting list
        </h2>
        <h3 className="font-[inter] px-4 md:px-0 text-2xl font-bold  md:leading-[52px] text-center md:text-start  leading-[120%] text-white tracking-[0%]">
        ...
        <input
          className="relative items-center md:items-start mx-auto md:mx-0 text-green-400 border-2 border-green-300 rounded-full p-3 bg-amber-50 my-6 w-[263px] placeholder:text-green-300"
          type="email"
        ...
        font-xl font-bold w-[263px]   transition delay-150 duration-300 ease-in-out hover:-translate-y hover:scale-110 uppercase"
        >
          join waiting list
        </button>
      </div>
