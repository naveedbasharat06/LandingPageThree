  ...
  return (
    <div className="NutrioScaleWinningChange_bg NutrioScaleWinningChange_bg_Mobile">
      <div className="relative px-[5%] py-[100px] md:py-[150px] lg:py-[175px] pl-30 md:pl-32 lg:pl-40 md:pr-6 lg:pr-10 flex flex-col w-[100%] md:w-[620px] lg:w-[815px] text-center  md:items-start">
        <h2 className="font-[Inter] font-light md:font-normal text-5xl md:leading-[52px] text-center md:text-start leading-[100%] px-10 md:px-0 mb-3 text-white tracking-[0%]">
        ...
        <input
          className="relative font-[inter] text-base items-center md:items-start mx-auto md:mx-0  border-2 border-[#A9C8A2] rounded-full p-3 bg-white my-6 w-[300px] placeholder:text-[#A9C8A2]"
          type="email"
        ...
        font-xl font-bold w-[289px] transition delay-150 duration-500 ease-in-out hover:-translate-y hover:scale-105 uppercase"
        >
          join waiting list
        </button>
      </div>
